...
class CollectionController extends Controller
{
    ...
    {
        return view('admin.collections.index', ['collections' => $this->collectionService->paginate($request->only('search'))]);
    }
    ...
    {
        $this->collectionService->create($request->validated(), $request->file('image'), $request->file('banner'), $request->file('banner_images', []));
    ...
    {
        $this->collectionService->update($collection, $request->validated(), $request->file('image'), $request->file('banner'), $request->file('banner_images', []));
