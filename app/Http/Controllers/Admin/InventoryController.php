...
class InventoryController extends Controller
{
    ...
    public function index(Request $request)
    {
        return view('admin.inventory.index', [
            'logs' => $this->inventoryService->paginate($request->only('product_id', 'type')),
    ...
    {
        return view('admin.inventory.adjust', ['products' => Product::with('variants')->ordered()->get()]);
    }
    ...
    {
        return view('admin.inventory.low-stock', ['products' => $this->inventoryService->getLowStockProducts()]);
    }
}
