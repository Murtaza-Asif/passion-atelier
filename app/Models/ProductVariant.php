...
class ProductVariant extends Model {
    use SoftDeletes;
    protected $fillable = ['product_id', 'color_id', 'sku', 'price', 'sale_price', 'stock', 'reserved_stock', 'low_stock_alert', 'image', 'is_default', 'sort_order', 'status'];
    ...
    public function isLowStock(): bool { return $this->available_stock <= $this->low_stock_alert; }
}
